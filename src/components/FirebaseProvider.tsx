...
import { auth, onAuthStateChanged, db, handleFirestoreError, OperationType } from '../firebase';
...
const ADMIN_EMAILS = ['aimanaimlengineer@gmail.com', 'aimanmaniyar20@gmail.com','adilabbas812@gmail.com'];
...
export function FirebaseProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <FirebaseContext.Provider value={{ user, profile, loading, profileLoading, isAuthReady }}>
      {children}
